              ...
              <div className="w-dyn-items w-row">
                <div className="w-col w-col-6 w-dyn-item">
                  <a
                    ...
                    href="/post/entrepreneur-working-on-his-macbook"
                  >
                ...
                <div className="w-col w-col-6 w-dyn-item">
                  <a
                    ...
                    href="/post/photographer-in-snowy-forest-taking-winter-photos"
                  >
                    <div className="blog-overlay">
                      <div className="blog-content">
                        <h1 className="journal-title">
                ...
                <div className="w-col w-col-6 w-dyn-item">
                  <a
                    ...
                    style={{
                      backgroundImage:
                        'url("https://daks2k3a4ib2z.cloudfront.net/57a4a82bae4229de1de385d1/57a8d41ea34e30ad0d5e87ba_blog-3.jpg")'
                    }}
                    href="/post/workspace-desk-from-above"
                  >
                    <div className="blog-overlay">
                      <div className="blog-content">
                        <h1 className="journal-title">
                ...
                <div className="w-col w-col-6 w-dyn-item">
                  <a
                    ...
                    style={{
                      backgroundImage:
                        'url("https://daks2k3a4ib2z.cloudfront.net/57a4a82bae4229de1de385d1/57a8d1d0c1305fe2094aa25e_blog-2.jpg")'
                    }}
                    href="/post/night-owl-man-working-on-computer-at-night"
                  >
                    <div className="blog-overlay">
                      <div className="blog-content">
                        <h1 className="journal-title">
